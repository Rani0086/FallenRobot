class Config(object):
    ...
    START_IMG = "https://files.catbox.moe/0bqdrz.jpg"

    SUPPORT_CHAT = "https://t.me/l_ABOUT_PRINCE_l

suppprt grouo and updated group"  # Your Telegram support group chat username where your users will go and bother you
